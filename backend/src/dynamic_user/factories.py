...
Phase 2 adds factories for ``User``/``Profile``/``Setting``/``AccountDeletionRequest`` here. A
host's own test suite is expected to import from here rather than hand-rolling equivalents.
